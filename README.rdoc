...
* Seller can mark order as 'Shipped' to inform buyers that their item
is on the way
...
* Make the buyer able to CORRECTLY purchase from multiple sellers with a
single checkout. This will require schema change!
